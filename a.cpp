...
int main()
{
    ...
    while (!time_keeper.isTimeOver())
    {
        ...
        // auto action = beamSearchAction(input, state, 3, 3);
        // auto action = beamSearchActionWithTimeThreshold(input, state, 3, 20);
        // auto action = chokudaiSearchAction(input, state, 3, 3, 50);
